...
```{r, message=FALSE}
library(readxl)
Pre_2022 <- read_xlsx("/Users/liqinxuan/Desktop/Dissertation/SATS_2022_Pre_Anon.xlsx")
Post_2022 <- read_xlsx("/Users/liqinxuan/Desktop/Dissertation/SATS_2022_Post_Anon.xlsx")
Pre_2023 <- read_xlsx("/Users/liqinxuan/Desktop/Dissertation/SATS_2023_Pre_Anon.xlsx")
Post_2023 <- read_xlsx("/Users/liqinxuan/Desktop/Dissertation/SATS_2023_Post_Anon.xlsx")
Demo_2022 <- read_xlsx("/Users/liqinxuan/Desktop/Dissertation/SATS_2022_Demographic_Anon.xlsx")
...
for (column in columns) {
  Pre_2022_clean[[column]] <- recode(Pre_2022_clean[[column]], 
                                     !!!setNames(scores, responses))
  
  # Reverse scores for negatively worded questions
  if (column %in% negatively_worded_questions) {
    Pre_2022_clean[[column]] <- 8 - Pre_2022_clean[[column]]
  }
}

columns <- paste0("Q", 1:36)
...
Pre_2022_clean$Affect <- rowMeans(Pre_2022_clean[c("Q3", "Q4", "Q15", "Q18", "Q19", "Q28")], na.rm = TRUE)
Pre_2022_clean$Cognitive_Competence <- rowMeans(Pre_2022_clean[c("Q5", "Q11", "Q26", "Q31", "Q32", "Q35")], na.rm = TRUE)
Pre_2022_clean$Value <- rowMeans(Pre_2022_clean[c("Q7", "Q10", "Q13", "Q16", "Q17", "Q21", "Q25", "Q33")], na.rm = TRUE)
Pre_2022_clean$Difficulty <- rowMeans(Pre_2022_clean[c("Q6", "Q8", "Q22", "Q24", "Q30", "Q34", "Q36")], na.rm = TRUE)
Pre_2022_clean$Interest <- rowMeans(Pre_2022_clean[c("Q12", "Q20", "Q23", "Q29")], na.rm = TRUE)
Pre_2022_clean$Effort <- rowMeans(Pre_2022_clean[c("Q1", "Q2", "Q14", "Q27")], na.rm = TRUE)
...
# Post 2022
# Create new columns for the means
Post_2022_clean$Affect <- rowMeans(Post_2022_clean[c("Q3", "Q4", "Q15", "Q18",
                                                     "Q19", "Q28")], na.rm = TRUE)
Post_2022_clean$Cognitive_Competence <- rowMeans(Post_2022_clean[c("Q5", "Q11",
                                                                   "Q26", "Q31",
                                                                   "Q32", "Q35")],
                                                 na.rm = TRUE)
#!!!!!!!!!!!!!ignore Q9
Post_2022_clean$Value <- rowMeans(Post_2022_clean[c("Q7", "Q10", "Q13", "Q16",
                                                    "Q17", "Q21", "Q25", "Q33")],
                                  na.rm = TRUE)
Post_2022_clean$Difficulty <- rowMeans(Post_2022_clean[c("Q6", "Q8", "Q22", 
                                                         "Q24", "Q30", "Q34", "Q36")],
                                       na.rm = TRUE)
Post_2022_clean$Interest <- rowMeans(Post_2022_clean[c("Q12", "Q20", "Q23", "Q29")],
                                     na.rm = TRUE)
Post_2022_clean$Effort <- rowMeans(Post_2022_clean[c("Q1", "Q2", "Q14", "Q27")],
                                   na.rm = TRUE)
...
Pre_2022_summary <- summary(Pre_2022_clean[, c("Affect", "Cognitive_Competence", "Value", "Difficulty", "Interest", "Effort")])
print(Pre_2022_summary)

# Calculate variance
for(column in c("Affect", "Cognitive_Competence", "Value", "Difficulty", "Interest", "Effort")) {
  cat("Variance of", column, ":", var(Pre_2022_clean[[column]], na.rm = TRUE), "\n")
}

# Melt the data into long format for easier plotting
Pre_2022_long <- melt(Pre_2022_clean[, c("Affect", "Cognitive_Competence", "Value", "Difficulty", "Interest", "Effort")], id.vars = NULL, variable.name = "Component", 
                      value.name = "Score")
...
# Post 2022
# Calculate statistical characteristics
Post_2022_summary <- summary(Post_2022_clean[, c("Affect", "Cognitive_Competence", "Value", "Difficulty", "Interest", "Effort")])
print(Post_2022_summary)

# Calculate variance
for(column in c("Affect", "Cognitive_Competence", "Value", "Difficulty", "Interest", "Effort")) {
  cat("Variance of", column, ":", var(Post_2022_clean[[column]], na.rm = TRUE), "\n")
}

# Melt the data into long format for easier plotting
Post_2022_long <- melt(Post_2022_clean[, c("Affect", "Cognitive_Competence", "Value", "Difficulty", "Interest", "Effort")], id.vars = NULL, variable.name = "Component", 
                      value.name = "Score")
...
Pre_2022_clean$Course <- "Pre"
Post_2022_clean$Course <- "Post"

# Combine the two dataframes
combined_2022 <- rbind(Pre_2022_clean, Post_2022_clean)
...
combined_2022_individual <- merge(Pre_2022_clean, Post_2022_clean, by = "AnonID", 
